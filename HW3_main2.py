...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def update_plot(self):
        if self.radioButton_all.isChecked():
            ...
            self.gView.getAxis('bottom').setTicks([[(i, Ticks[i-1]) for i in x]])
            ...
            self.gView.setLabel('bottom', 'college', color='red', size=30)
    ...
    def table_rank(self):
        ...
        if self.radioButton_cate.isChecked():
            ...
            self.gView.setLabel('bottom', 'college', color = 'yellow', size = 30)
