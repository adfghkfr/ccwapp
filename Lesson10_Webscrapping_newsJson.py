...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi('Lesson10_Webscrapping_newsJson.ui', self)
        self.url = "https://news.ltn.com.tw/ajax/breakingnews/popular/"
        self.newsSearch()
        
        # Signals
        self.tableView.doubleClicked.connect(self.rowSelected) #看row裡面有什麼
    ...
    def rowSelected(self, mi):
        ...
        img_dir = "/Users/guoyixuan/Documents/pythoncode/ccwapp/news_img/"
