...
# 注意 PyQt6 跟 PyQt6-WebEngine 的版本是否相同
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi('Lesson11_geo_taiwan_border.ui', self)
        f = open('/Users/guoyixuan/Documents/pythoncode/ccwapp/geo_taiwan.json',encoding='utf8')
    ...
    def show_map(self):
        ...
        # 在ui檔中，除了原本就要加入的vertical layout,也加入了一個widget並進行提升到QWebEngineView，比起只用vertical layout可以少掉一串程式碼
    ...
    def get_city(self):
        ...
        for i in range(len(self.data['features'])):
            cities.append(self.data['features'][i]['properties']['name']) # 看html檔案中的features    
