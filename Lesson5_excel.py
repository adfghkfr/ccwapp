...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi('Lesson5_excel.ui', self)
    ...
    def fileOpen(self):
        ...
        if fname[0]:
            ...
            self.comboBox_col.currentIndexChanged.connect(self.update_plt2)
    ...
    def update_plt1(self):
        self.plt1.clear()
        col_name = self.comboBox_col.currentText()
        y, x = np.histogram(self.df[col_name])
        ...
        self.plt1.setTitle(col_name)
 
    def update_plt2(self):
        self.plt2.clear()
        col_name = self.comboBox_col.currentText()
        if isinstance(self.df[col_name][0], str) or isinstance(self.df[col_name][0], str) :
        ...
        # if self.df[self.df.columns[0]][0]== float and self.df[self.df.columns[1]][0]== float :
            self.plt2.plot(self.df[col_name], self.df[col_name], pen=None, symbol='o', symbolSize=5)
